...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  workspacePresentation: 'client-side Workspace presentation registry — packages/client/ui-workspace/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  CompactionSummarizationTarget: 'compaction.md',
  ManualCompactionOptions: 'compaction.md',
  CompactionResult: 'compaction.md',
  CompactionTrigger: 'compaction.md',
  PruneResult: 'compaction.md',
  GlobalMemoryScope: 'memory.md',
  WorkspaceMemoryScope: 'memory.md',
  MemoryScope: 'memory.md',
  MemoryId: 'memory.md',
  MemoryRecord: 'memory.md',
  MemoryCreateRequest: 'memory.md',
  MemoryPatch: 'memory.md',
